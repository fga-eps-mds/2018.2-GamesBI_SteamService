...
migrations:
	...
	sudo docker-compose run steamweb python manage.py makemigrations importdata

migrate:
	# Migrate migrations from importdata on database
	sudo docker-compose run steamweb python manage.py migrate importdata
...
loaddata:
	...
	sudo docker-compose run steamweb python manage.py loaddata steam_data.json
